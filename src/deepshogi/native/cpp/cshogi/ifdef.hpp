...
// クラスで持つようにする。
// LibTorchの`STATIC`と競合するため、マクロ`STATIC`を`CSHOGI_STATIC`に変更 @takedarts
// ただし、`STATIC`は使用されていないため他への影響はない @takedarts
#define USE_GLOBAL
#define CSHOGI_STATIC static
#else
#define CSHOGI_STATIC
#endif
