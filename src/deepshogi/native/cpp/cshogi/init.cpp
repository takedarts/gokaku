        ...
        for (Square sq0 = SQ11; sq0 < SquareNum; ++sq0) {
            for (Square sq1 = SQ11; sq1 < SquareNum; ++sq1) {
                ...
                case DirecMisc:
                    ...
                    break;
                case DirecFile:
                    SquareDistance[sq0][sq1] = std::abs(static_cast<int>(sq0 - sq1) / static_cast<int>(DeltaN));
                    break;
                case DirecRank:
                    SquareDistance[sq0][sq1] = std::abs(static_cast<int>(sq0 - sq1) / static_cast<int>(DeltaE));
                    break;
                case DirecDiagNESW:
                    SquareDistance[sq0][sq1] = std::abs(static_cast<int>(sq0 - sq1) / static_cast<int>(DeltaNE));
                    break;
                case DirecDiagNWSE:
                    SquareDistance[sq0][sq1] = std::abs(static_cast<int>(sq0 - sq1) / static_cast<int>(DeltaNW));
                    break;
                default: UNREACHABLE;
                }
            }
